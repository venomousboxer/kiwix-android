...
public class ReadingListItemPopup extends AbstractItem<ReadingListItemPopup,ReadingListItemPopup.ViewHolder> {
  ...
  public ReadingListItemPopup(String title) {
    this.title = title;
  }
  ...
  public int getLayoutRes() {
    return R.layout.item_readinglist_popup;
  }
