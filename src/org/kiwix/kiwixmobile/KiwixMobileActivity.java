...
public class KiwixMobileActivity extends AppCompatActivity implements WebViewCallback {
  ...
  private static final int REQUEST_BOOKMARK_CHOSEN = 1;

  public static final String TAG_KIWIX = "kiwix";

  public static final String EXTRA_FILE_SEARCHED = "searchedarticle";

  private static final String PREF_CURRENT_FILE = "currentzimfile";

  private static final String PREF_CURRENT_ARTICLES = "currentarticles";

  private static final String PREF_CURRENT_POSITIONS = "currentpositions";
  ...
  public void restoreTabStates() {
    SharedPreferences settings = getSharedPreferences(PREF_KIWIX_MOBILE, 0);
    String zimFile = settings.getString(PREF_CURRENT_FILE, null);
    String zimArticles = settings.getString(PREF_CURRENT_ARTICLES, null);
    String zimPositions = settings.getString(PREF_CURRENT_POSITIONS, null);

    int currentTab = settings.getInt(PREF_CURRENT_TAB, 0);
